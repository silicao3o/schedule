...
public class CommentController {
    ...
    public Long deleteComment(@PathVariable Long id, @RequestBody CommentRequestDto commentRequestDto) {
        return commentService.deleteComment(id, commentRequestDto);
    }
}
